...
- [ ] `/agentrx:trial-evaluate` - Run evaluation metrics across all trials
- [ ] `/agentrx:trial-merge <approach>` - Merge winning approach to main
- [ ] `/agentrx:trial-cleanup` - Remove all worktrees
- [ ] `/agentrx:trial-compare <approach1> <approach2>` - Diff two trials
- [ ] Background agent spawning with progress monitoring
- [ ] Automated metric collection from trial runs
- [ ] Integration with Claude Code skill system for true `/agentrx:` commands
