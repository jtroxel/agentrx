...
When `/agentrx:trial-work <approach>` is called:
...
- [ ] `/agentrx:trial-evaluate` - Run evaluation framework
- [ ] `/agentrx:trial-merge <approach>` - Merge learnings to main
- [ ] `/agentrx:trial-cleanup` - Remove worktrees
