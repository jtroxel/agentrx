...
echo "  2. Bootstrap your coding agent(s):"
echo "     $AGENTRX_DIR/scripts/agentrx/adapt-agent.sh all"
echo "     (or: adapt-agent.sh claude-code | github-copilot | cursor)"
echo "  3. Add your project code to $PROJECT_DIR/src/"
echo "  4. Use /arx:prompt-new to create prompts"
echo "  5. Use /arx:trial-init for parallel development"
echo ""
